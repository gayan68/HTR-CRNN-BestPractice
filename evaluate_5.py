...
class HTREval(nn.Module):
    ...
    def prepare_dataloaders(self):
        ...
        train_set = HTRDataset(config, dataset_folder, 'train', fixed_size=fixed_size, transforms=None)
        ...
        val_set = HTRDataset(config, dataset_folder, 'val', fixed_size=fixed_size, transforms=None)
        print('# validation lines ' + str(val_set.__len__()))

        test_set = HTRDataset(config, dataset_folder, 'test', fixed_size=fixed_size, transforms=None)
...
print("\n## Val Dataset ##")
print(f"CER: {results_val[0][0]}")
print(f"WER: {results_val[0][1]}")

print("\n## Test Dataset ##")
print(f"CER: {results_test[0][0]}")
print(f"WER: {results_test[0][1]}")
