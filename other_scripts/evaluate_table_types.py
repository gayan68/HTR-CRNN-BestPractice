...
df.to_csv('results_types.csv', index=True)
...
# df_cer.to_csv('df_cer_dataV3_noBlots_p50_100_all_p2.csv', index=False)
# df_wer.to_csv('df_wer_dataV3_noBlots_p50_100_all_p2.csv', index=False)
