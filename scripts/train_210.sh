...
root=/home/x_gapat/PROJECTS/codes/HTR-CRNN-BestPractice
...
echo "currentDate :"
echo $CURRENTDATE
PATHLOG="/home/x_gapat/PROJECTS/logs/HTR-CRNN-BestPractice/${EXPERIMENT_ID}_${CURRENTDATE}_ID_${SLURM_JOB_ID}/"
echo "path log :"
echo ${PATHLOG}
mkdir ${PATHLOG}
...
export PYTHONPATH=/proj/document_analysis/users/x_gapat/codes/HTR-CRNN-BestPractice/
